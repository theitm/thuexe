...
<div>
  <?php
    ...
    100px; padding-left: 50px;">
      <input type="form" name="findxe" value= "search" placeholder="Tìm">
      <button type="submit" name="submit" class="btn btn-success">Tìm xe</button>
    ...
    <div class="container" >
      ...
      echo "</div>";
            ...
            if ($current_page > 1 && $total_page > 1){
                echo '<a href="pay.php?page='.($current_page-1).'">Prev</a> | ';
            }
            ...
            for ($i = 1; $i <= $total_page; $i++){
                ...
                if ($i == $current_page){
                    ...
                    echo '<a href="pay.php?page='.$i.'">'.$i.'</a> | ';
                }
            }
 
            // nếu current_page < $total_page và total_page > 1 mới hiển thị nút prev
            if ($current_page < $total_page && $total_page > 1){
                echo '<a href="pay.php?page='.($current_page+1).'">Next</a> | ';
            }
          }
        }
           ?>
